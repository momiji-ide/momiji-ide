...
const MODEL_PRESETS: Record<string, { label: string; model: string; badge?: string }[]> = {
  claude: [
    { label: 'Haiku 4.5',   model: 'claude-haiku-4-5',   badge: 'fastest·cheap' },
    { label: 'Sonnet 4.6',  model: 'claude-sonnet-4-6',  badge: 'recommended ⭐' },
    { label: 'Opus 4.7',    model: 'claude-opus-4-7',    badge: 'best·new' },
  ],
  gemini: [
    { label: '3.1 Flash-Lite', model: 'gemini-3.1-flash-lite', badge: 'free·500RPD' },
    { label: '3.5 Flash',      model: 'gemini-3.5-flash',      badge: 'new ⭐' },
    { label: '2.5 Flash',      model: 'gemini-2.5-flash',      badge: 'BYOK' },
    { label: '3 Pro',          model: 'gemini-3-pro',          badge: 'best' },
  ],
  openai: [
    { label: 'GPT-5 Mini',  model: 'gpt-5-mini',  badge: 'fast·new' },
    { label: 'GPT-5',       model: 'gpt-5',       badge: 'recommended ⭐' },
    { label: 'GPT-5.5',     model: 'gpt-5.5',     badge: 'latest' },
    { label: 'o3 Mini',     model: 'o3-mini',     badge: 'reasoning' },
  ],
  groq: [
    ...
    { label: 'DeepSeek R1',   model: 'deepseek-r1-distill-llama-70b', badge: 'free·reason' },
    { label: 'Qwen QwQ 32B',  model: 'qwen-qwq-32b',           badge: 'free·reason' },
  ],
  openrouter: [
    { label: 'Llama 3.3 70B',  model: 'meta-llama/llama-3.3-70b-instruct:free', badge: 'free ⭐' },
    { label: 'DeepSeek R1',    model: 'deepseek/deepseek-r1:free',               badge: 'free·reason' },
    { label: 'Gemma 3 27B',    model: 'google/gemma-3-27b-it:free',              badge: 'free' },
    { label: 'Claude Sonnet',  model: 'anthropic/claude-sonnet-4-6',             badge: 'paid' },
    { label: 'GPT-5',          model: 'openai/gpt-5',                            badge: 'paid' },
  ],
  deepseek: [
    { label: 'DeepSeek V3',  model: 'deepseek-chat',     badge: 'recommended ⭐' },
    { label: 'DeepSeek R1',  model: 'deepseek-reasoner', badge: 'reasoning' },
  ],
  mistral: [
    { label: 'Small 3.1',   model: 'mistral-small-latest',  badge: 'cheap ⭐' },
    { label: 'Medium 3',    model: 'mistral-medium-latest', badge: 'balanced' },
